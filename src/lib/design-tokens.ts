...
export const buttons = {
  base: 'w-full border-2 p-3 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1',
  ...
  panel: 'border-2 border-black px-4 py-3 font-display uppercase text-lg transition-colors cursor-pointer',
  panelPrimary: 'bg-black text-white hover:bg-gray-800',
  panelSecondary: 'hover:bg-gray-100',
  panelInvert: 'hover:bg-black hover:text-white',
  panelDisabled: 'disabled:opacity-50',
} as const;
